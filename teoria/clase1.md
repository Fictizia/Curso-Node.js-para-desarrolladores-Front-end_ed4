...
## Introducción y flujo de trabajo con Git/Github
...
**3 -** Presentate en este [issue](https://github.com/Fictizia/Curso-Node.js-para-desarrolladores-Front-end_ed4/issues/1)

**4 -** Contactame por [Slack](https://invitations-osweekends.herokuapp.com/), utilizando mensajes personales y facilitame tu email para poder conectarte a c9.io como estudiante.